...
question_dict = {
   ...
   "question17":{
    ...
    "question18":{
       "prompt": "What is the main cause of global tropical deforestation?",
       "options": ["Soybean production", "Timber logging", " Beef production", "Forest fires"],
       "correct": 3,
       "explanation": "The international commuity is focusing on biodiversity conservation and deforestation is one of the major threats to it. As shown in the graph, over the past decade global forest cover has decreased drastically with a sharp downwards trend. Primary forests, including tropical moist forests have the most species rich, diverse terrestrial ecosystems. Habitat loss due to human activities and production purposes is one of the biggest drivers of tropical deforestation. Beef production is the top driver of deforestation in the world’s tropical forests. The forest conversion it generates more than doubles that generated by the production of soy, palm oil, and wood products (the second, third, and fourth biggest drivers) combined (worldwildlife.org, 2018).",
       "graph": forest
    
    },
    "question19":{
       "prompt": "OECD members and least developed countries have the highest and lowest electricity production from coal sources respectively. What is the difference in electricity production from coal sources (% of total) between OECD members and least developed countries? ",
       "options": ["5.9 %", "60.1 %", " 27.7 %", "16.5 %"],
       "correct": 3,
       "explanation": "The international commuity is focusing on biodiversity conservation and deforestation is one of the major threats to it. As shown in the graph, over the past decade global forest cover has decreased drastically with a sharp downwards trend. Primary forests, including tropical moist forests have the most species rich, diverse terrestrial ecosystems. Habitat loss due to human activities and production purposes is one of the biggest drivers of tropical deforestation. Beef production is the top driver of deforestation in the world’s tropical forests. The forest conversion it generates more than doubles that generated by the production of soy, palm oil, and wood products (the second, third, and fourth biggest drivers) combined (worldwildlife.org, 2018).",
       "graph": coal
    ...
    "question20":{
       "prompt": "What is France's percentage share of alternative and nuclear energy sources from its total energy production? ",
       "options": NUMBER,
       "correct": 49.1,
       "explanation": "Alternative and nuclear energy sources are alternatives to traditional fossil fuels that can be used to generate electricity. These include renewable sources like solar, wind, and hydro power, as well as non-renewable sources like nuclear power. Increasing the use of these energy sources can help reduce greenhouse gas emissions and combat climate change. Many countries have set goals to increase the percentage of total energy use supplied by alternative and nuclear energy as part of their efforts to transition to a low-carbon energy system.  As shown in the graph below, France was leading globally in 2015 with 49.1 percent share of global alternative and nuclear energy sources. Current alternative and nuclear energy shares were 26 percent in 2021 (increase from 13.4 percent in 2015).",
       "graph": energy
    }
}
...
Thus, even when an economy is operating at its maximum efficiency, there will still be natural unemployment. In general accepted theory, when the growth rate of a country's economy increases, it is expected that employment will increase and the unemployment rate will decrease on average. 
    ...
    "Water Conservation": """
    Water conservation is an important aspect of sustainability, as it involves using water efficiently and reducing the amount of water that is wasted. According to the World Bank, water scarcity is a major concern in many parts of the world, as demand for water is increasing due to population growth, urbanization, and climate change. Water scarcity can have serious consequences for communities, economies, and the environment, as it can lead to conflicts over water resources, damage to ecosystems, and reduced agricultural productivity. 
The Organization for Economic Cooperation and Development (OECD) has identified water conservation as a key element of sustainable water management, along with water efficiency, water treatment and reuse, and water pricing. The OECD has also published a number of reports on water conservation, including one that highlights the importance of water conservation in the agriculture sector, which accounts for 70% of global water use.Global statistics on water conservation are difficult to quantify, as data on water use and conservation practices vary widely between countries and regions.
However, it is clear that water conservation is an important and necessary step towards achieving sustainability, as it helps to reduce demand on limited water resources and protect the environment.
                  """
}
...
def question17():
   ...
   put_buttons(["Next"], onclick=[question18])

def question18():
   make_question_checkbox(**question_dict["question18"])
   put_buttons(["Next"], onclick=[question19])

def question19():
   make_question_checkbox(**question_dict["question19"])
   put_buttons(["Next"], onclick=[question20])

def question20():
   make_question_input(**question_dict["question20"])
